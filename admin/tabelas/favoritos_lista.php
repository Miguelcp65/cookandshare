...
<head>
    ...
    <script type="text/javascript" charset="utf8" src="../../assets/js/favoritos_lista.js"></script>
...
<br>
    <div class="main-card mb-3 card">
        <div class="card-body">
            <div class="tabela">
                <h2 class="m-0 text-dark">Tabela de Favoritos</h2>
            </div>
            <div class="table-responsive" >
                ...
                <tbody>
                    <?php 
                     $result = mysqli_query($conn, "SELECT * FROM favoritos");
