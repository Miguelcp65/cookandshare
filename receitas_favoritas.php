...
<head>
    ...
    <title>CN'S | Receitas Favoritas</title>
</head>
...
?>
 <div class="dbreadcrumb" aria-label="breadcrumb">
    ...
    <h1 class="minhasr">Receitas Favoritas</h1>
    <main class="cd-main-content">
        ...
        <section class="cd-gallery">
            <ul>
            <?php 
            $favquery = mysqli_query($conn, "SELECT * FROM favoritos WHERE id_user=$user_id_se");
            foreach($favquery as $favrow) {
               $favidr = $favrow['id_receita'];
               $favidr = intval($favidr); 
               $resultrec = mysqli_query($conn, "SELECT receitas.nome, receitas.estado, receitas.id_user, receitas.npessoas, receitas.duracao, receitas.dificuldade, receitas.id_categoria, receitas.id_receita, 
                ...
                WHERE receitas.id_receita =$favidr ORDER BY classificacao DESC");
